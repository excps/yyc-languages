    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-12">
        <div className="text-center max-w-3xl mx-auto mb-8">
          <h1 className="text-4xl text-gray-900 mb-4">About YYC-Languages</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600">
              ...
              lessons for learners of all levels—from those just starting out to
              those refining advanced skills.
            </p>
            <p className="text-lg text-gray-600">
              Our teaching style combines trusted language-learning techniques
              with modern tools and interactive activities, making each session
              engaging and effective. Whether you’re learning German for work,
              study, travel, or simply for the joy of it, we’re here to guide
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 space-y-4">
              ...
              <p className="text-lg text-gray-600">
                ...
                teaching experience. Andrea specializes in exam preparation and
                brings a unique perspective from living in both Germany and
                Canada.
              </p>
              <Link
                to="/meet-andrea"
