    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-12">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl text-gray-900 mb-4">Meet Andrea</h1>
          <p className="text-xl text-gray-600">
            Your dedicated German language instructor with 25 years of
            experience
          </p>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="p-8 md:p-12 space-y-6 flex flex-col justify-center">
                ...
                <p className="text-lg text-gray-600">
                  ...
                  culture make every lesson engaging and insightful. Her
                  students consistently achieve their language goals and develop
                  a lasting appreciation for the German language.
                </p>
                <p className="text-lg text-gray-600">
                  Specializing in exam preparation, Andrea helps students
                  prepare for Goethe-Zertifikat and Telc exams. Her personalized
                  approach ensures that each student receives instruction
                  tailored to their learning style and goals.
                </p>
              </div>
            </div>
          </div>
